                     ...
                     @foreach(Cart::getContent() as $p)
                        <tr class="cart_item">
                           ...
                           <td class="product-remove">
                              <a href="{{ route('cart.remove',['id'=>$p->id]) }}" class="product-del remove" title="Remove this item">
                                 <i class="seoicon-delete-bold"></i>
                              </a>
                           </td>
                           ...
                           <td class="product-thumbnail">
                              ...
                              <div class="cart-product__item">
                                 <a href="{{ route('product.show',['id'=>$p->id]) }}">
                                    <img src="{{ $p->attributes['image'] }}" width="80px" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                 </a>
                           ...
                           <td class="product-price">
                              <h5 class="price amount">${{ number_format($p->price) }}</h5>
                           </td>
